...
$opts = array(
	...
	'roots' => array(
		...
		array(
			...
			'path'          => '/usr/share/webapps',                 // path to files (REQUIRED)
			'URL'           => dirname($_SERVER['PHP_SELF']) . '/../../../htdocs', // URL to files (REQUIRED)
			'trashHash'     => 't1_Lw',                     // elFinder's hash of trash folder
			'winHashFix'    => DIRECTORY_SEPARATOR !== '/', // to make hash same to Linux one on windows too
		//	'uploadDeny'    => array('all'),                // All Mimetypes not allowed to upload
		//	'uploadAllow'   => array('image/x-ms-bmp', 'image/gif', 'image/jpeg', 'image/png', 'image/x-icon', 'text/plain', 'application/x-httpd-php', 'application/xhtml+xml'), // Mimetype `image` and `text/plain` allowed to upload
		//	'uploadOrder'   => array('deny', 'allow'),      // allowed Mimetype `image`, `text/plain` , 'php' and 'html/xml' only
